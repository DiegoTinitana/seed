...
export class createUser1660753981705 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `INSERT INTO users(name, "lastName", email, password, dni, "createdBy" , "updatedBy", "isActive", roles) VALUES ('test1', 'tini', 'test1@gmail.com', '${password}', '12344432', 'system', 'system', true, '["${role[0].id}"]')`
        );
    }
