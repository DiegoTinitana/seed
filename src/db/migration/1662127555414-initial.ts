...
export class initial1662127555414 implements MigrationInterface {
    name = 'initial1662127555414';
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query('ALTER TABLE "items_categories_categories" ADD CONSTRAINT "FK_79e54354b90b7e850d8370c9cb5" FOREIGN KEY ("categoriesId") REFERENCES "categories"("id") ON DELETE CASCADE ON UPDATE CASCADE');
    }
